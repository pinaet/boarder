...
<template>
    <button class="border-stroke-gray-3 border ml-1 pl-1 w-36 h-[38px] rounded-md flex justify-evenly items-center relative" @click="showList=!showList">
        ...
        <div v-show="showList" class="absolute top-[37px] -left-[1px] z-30 w-36 shadow-md border border-t-0 border-stroke-gray-3 rounded-b-md overflow-clip bg-fill-gray-2">
